<template>
  <div v-if="type == 'daterange'">
    <date-panel :isDropdownVisible="isDropdownVisible" :refOfDropdown="refOfDropdown" ref="inlinePicker" />
  </div>
  <el-input
...
export default {
  ...
  mounted() {
    if (this.type === "daterange") {
      ...
      picker.visible = true;
      picker.$on("pick", (date = "", visible = true) => {
        // this.userInput = null;
        this.emitInput(date);
  ...
  methods: {
    ...
    mountPicker() {
      ...
      this.picker.$on("pick", (date = "", visible = true) => {
        this.userInput = null;
        this.emitInput(date);
      });
    },
